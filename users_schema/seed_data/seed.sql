...
INSERT INTO users.tenant(tenant_id, cognito_userpool, name, created_date, description, active)VALUES (tenant-11-retail,us-east-1_KrHINMq5U,leftlane-retail-tenant,,This tenant is used to enroll retail users,t);
